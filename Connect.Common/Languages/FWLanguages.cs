...
namespace Connect.Common.Languages
{
    public class FWLanguages
    {
        public static string LFooterTooltipText = @"Tooltip is show by VSC Systems.";
        public static string LHeadTooltipText = @"VSC Infomation";
        public static string LDelete = @"Xóa";
        public static string LEdit = @"Sửa";
        public static string LNew = @"Thêm mới";


        public static string LItemDafaultName = @"Không chọn ...";
